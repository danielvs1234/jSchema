...
import org.xtext.example.mydsl.parser.antlr.internal.InternalJSchemaParser;
import org.xtext.example.mydsl.services.JSchemaGrammarAccess;

public class JSchemaParser extends AbstractAntlrParser {
	...
	@Override
	protected InternalJSchemaParser createParser(XtextTokenStream stream) {
		return new InternalJSchemaParser(stream, getGrammarAccess());
	}
